...
do
	echo $i
	python alldist-with-graph.py /home/fimz/Dev/datasets/500-dataset/reverse/$i $i /home/fimz/Dev/datasets/500-results/reverse
	mv /home/fimz/Dev/scripts/output/* /home/fimz/Dev/datasets/500-results/reverse/$i/
done
