...
do
	echo $i
	python rev-combncdspam.py --sigdir /home/fimz/Dev/datasets/signatures/50/$i --datdir /home/fimz/Dev/datasets/500-dataset/raw/$i --iter $i --outdir /home/fimz/Dev/datasets/500-results/rev 
